...
public class CarGameActivity extends AppCompatActivity
    ...
    private void initialVariables() {
        ...
        handlerDelay = 50;
        playerNumber = 0;
        windowWidth = binding.road11.getWidth();
        ...
        playWithRobot = false;
        backgroundWidth = (int) (windowWidth - (binding.road11.getWidth() * 1.2));
        showSpeed = true;
        looseTimer = 0;
        accelerateOn = false;
    ...
    private int startMoving(ImageView playerImg, ConstraintLayout playerImgLayout,
        ...
        if (carPosition < binding.road11.getWidth() - binding.car1.getWidth()) {
    ...
    private void resetFieldsOnPage() {
        moveCarSoundPlay = false;
